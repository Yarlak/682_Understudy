...
public class coach_test_Agent : Agent {
    ...
    void Start () 
	{
		...
		the_what = new StreamReader("C:/Users/OH YEA/Documents/NN_Final Project/ML Agents/unity-environment/Assets/ML-Agents/Examples/Test-L2/test_points.csv");
		int count = 0;
    ...
    public override void AgentReset()
    {
		...
		if (spawn_count != 100 && failed == false)
		{
			...
			Target.GetComponent<dubs3_test_reward>().is_active = 1;
			...
			Target1.GetComponent<dubs3_test_reward>().is_active = 1;
			Target1.GetComponent<Renderer>().material.color = Color.yellow;
				
			other.GetComponent<dubs3_test_Agent>().Done();
			other1.GetComponent<dubs3_test_Agent>().Done();			
	...
	public override void CollectObservations()
	{
		...
		AddVectorObs(Target.GetComponent<dubs3_test_reward>().is_active);
		AddVectorObs(Target1.GetComponent<dubs3_test_reward>().is_active);
